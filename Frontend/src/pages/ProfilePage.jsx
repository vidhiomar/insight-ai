      ...
      <div className="p-6 max-w-3xl">
        ...
        <div className="glass-card p-6 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <span className="inline-block mt-1 text-xs px-2 py-0.5 rounded-full bg-foreground/10 text-foreground/70">Pro Plan</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-6">
          {usageStats.map((stat, i) => (
            ...
            >
              <stat.icon className="w-5 h-5 text-foreground/60 mx-auto mb-2" />
        ...
        <div className="glass-card p-6">
          <h3 className="font-semibold text-sm mb-4 text-foreground">Account Details</h3>
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between py-2">
              ...
              <span className="font-mono text-xs text-foreground">sk-••••••••••4f2a</span>
            </div>
          </div>
        </div>
      </div>
