...
export default function SettingsPage() {
  ...
  const selectClass = "w-full bg-secondary/50 border border-border rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-primary/50 transition-colors";
